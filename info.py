...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8401840239 1856765089').split()] # Replace with the actual admin ID(s) to add
